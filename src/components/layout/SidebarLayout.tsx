      ...
      <aside className="min-h-screen">
        <div
          className={`${
            ...
            // } md:translate-x-0 sticky overflow-y-auto max-h-screen top-0 left-0 bottom-0 w-80 bg-white flex flex-col justify-between text-black shadow-lg transition-transform duration-300 z-50 md:relative md:w-64`}
          } h-screen flex overflow-hidden min-h-screen md:translate-x-0 fixed top-0 left-0 bottom-0 w-80 bg-white flex flex-col justify-between text-black shadow-lg transition-transform duration-300 z-50 md:relative md:w-64`}
        >
          {/* <div
        className={`${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
